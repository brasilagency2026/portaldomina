...
import { MapPin, Tag, Crown, Lock, User as UserIcon, Image as ImageIcon, Plus, Trash2, Home, Hotel, Car, Plane, PartyPopper } from "lucide-react";
...
export default function Dashboard() {
  ...
  const addPhoto = () => {
    ...
    if (currentFotos.length >= limit) {
      toast.error(`Limite de ${limit} fotos atingido para seu plano.`);
      return;
    }
              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline">
                    {perfil.fotos?.length || 0} / {perfil.is_premium ? 20 : 5} fotos
                  </Badge>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
